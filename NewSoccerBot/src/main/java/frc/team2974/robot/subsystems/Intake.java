...
public class Intake extends AbstractIntake {
  ...
  private static final double transitionUpHigh = 150;
  private static final double transitionLowFlat = 66;
  ...
  // unused
  public final void setDribbleMode() {
    transitionHighDribble = 660;
    transitionDribbleLow = 620;
  }

  // unused
  public final void setLoadMOde() {
